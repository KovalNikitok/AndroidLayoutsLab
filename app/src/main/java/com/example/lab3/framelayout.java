...
public class framelayout extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        XBoxSX = getView().findViewById(R.id.imgXboxSX);
        PS5 = getView().findViewById(R.id.imgPS5);

        XBoxSX.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                XBoxSX.setVisibility(View.GONE);
        ...
        PS5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                XBoxSX.setVisibility(View.VISIBLE);
                PS5.setVisibility(View.GONE);
            }
        });

        final NavController navController = Navigation.findNavController(view);
        Button backButton= view.findViewById(R.id.ConsoleBackbutton);
